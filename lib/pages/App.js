...
import buttonStyles from '../../styles/components/ViewDataLink.module.less';
export default class App extends Component {
  ...
  constructor(props) {
    ...
    this.handleClickViewUploadHistory = this.handleClickViewUploadHistory.bind(this);
  ...
  handleClickViewUploadHistory() {
    const { setPage } = this.props.sync;
    setPage(pages.UPLOAD_HISTORY, true);
  }

  handleBackToMain() {
    const { setPage } = this.props.sync;
    setPage(pages.MAIN, true);
  }
  ...
  renderPage() {
        ...
        <div className={styles.mainWrap}>
          ...
          <div className={buttonStyles.buttonWrap}>
            <button
              ...
              onClick={this.handleClickViewUploadHistory}
            >
              Previous uploads
            </button>
          </div>
    ...
    } else if (page === pages.UPLOAD_HISTORY) {
      return (
        <div>
            <UploadHistory
              uploadHistory={this.props.uploadHistory || []}
              onDoneClicked={this.handleBackToMain}
              isUploadInProgress={this.props.uploadIsInProgress}
            />
        </div>
      );
    ...
    return (
      <div className={styles.footerRow}>
        ...
        <div className="mailto">
          <a className={styles.footerLink} href="mailto:support@tidepool.org?Subject=Feedback on Blip" target="mailto">Send us feedback</a>
        </div>
