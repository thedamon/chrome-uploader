...
export default class App extends Component {
  ...
  constructor(props) {
    ...
    this.handleClickViewUploadList = this.handleClickViewUploadList.bind(this);
  ...
  handleClickViewUploadList() {
    const { setPage } = this.props.sync;
    setPage(pages.LISTUPLOADS, true);
  }
        ...
        <div className={styles.mainWrap}>
          ...
          <div className={buttonStyles.buttonWrap}>
            <button
              ...
              onClick={this.handleClickViewUploadList}
            >
              Previous uploads
            </button>
          </div>
